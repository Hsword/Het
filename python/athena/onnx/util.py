...
from athena.onnx import constants,util
...
#
#mapping dtypes from athena to onnx
#
#fixme:bug,(int64) type is error
#fixme:unused now
ATHENA_TO_ONNX_DTYPES={
...
def map_athena_dtype(dtype):
    if dtype:
        dtype=ATHENA_TO_ONNX_DTYPES[dtype]
    return dtype
