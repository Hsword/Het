...
class Conv2dOp(Op):
    ...
    def gradient(self, output_grad):
        return [conv2d_gradient_of_data_op(self.inputs[1], output_grad, self.padding, self.stride, ctx=output_grad.ctx), \
            conv2d_gradient_of_filter_op(self.inputs[0], output_grad, self.padding, self.stride, ctx=output_grad.ctx)]
