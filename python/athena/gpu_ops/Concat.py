...
class ConcatOp(Op):
    ...
    def gradient(self, output_grad):
        return [concat_gradient_op(output_grad, self.inputs[0], self.axis, idx=0, ctx=output_grad.ctx),
                concat_gradient_op(output_grad, self.inputs[1], self.axis, idx=1, ctx=output_grad.ctx)]
