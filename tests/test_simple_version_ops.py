...
test_slice(shape1=(2, 3, 4, 5, 6), shape2=(1, 2, 3, 4, 5), begin_pos=(0, 1, 0, 1, 0))


def test_add(shape=(2, 3, 4, 5), ctx=ndarray.gpu(1)):
    x = np.random.random(shape).astype(np.float32)
...
test_add_broadcast(ctx=ndarray.cpu(0))
test_add_broadcast((9,), (7, 9), ctx=ndarray.cpu(0))
test_add_broadcast((4, 5, 6, 7, 8), (1, 7, 1), ctx=ndarray.cpu(0))
...
test_add_lazy(ctx=ndarray.cpu(0))
test_add_lazy((9,), (7, 9), ctx=ndarray.cpu(0))
test_add_lazy((1, 7, 1), (4, 5, 6, 7, 8), ctx=ndarray.cpu(0))
