...
from athena.ndarray import numpyasdlarrayhandle
...
ll = [10, 50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000]
...
def test_max_pooling():
    ...
    cpu_op.max_pool_gradient(arr_x, arr_pool_layer, 2, 2, arr_gradient_x1,0,2)
