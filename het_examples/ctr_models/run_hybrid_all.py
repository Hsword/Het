...
# ../build/deps/bin/mpirun --allow-run-as-root -np 8 python run_hybrid_all.py --model
# ../build/_deps/openmpi-build/bin/mpirun -np 8 --allow-run-as-root python run_hybrid_all.py --model
...
def main():
    ...
    parser.add_argument("--config", type=str, default="../config/local_w8.yml", help="configuration for ps")
