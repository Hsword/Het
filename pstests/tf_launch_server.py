...
def main():
    ...
    parser.add_argument("--config", type=str, default='./settings/tf_dist_s4_w2.json', help="config file path")
    ...
    global proc
    proc = multiprocessing.Process(target=start_server, args=[cluster, args.id, ])
    proc.start()
